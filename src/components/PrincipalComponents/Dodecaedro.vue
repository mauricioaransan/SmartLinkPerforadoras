<template>
    <v-sheet :color="colorCard" class="backDodecahedrom">
        <svg class="dodecahedrom" fill="#000000" height="100px" width="100px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
        ...
        <v-sheet class="titleDodecahedromCard" color="transparent" width="110" height="110" style="text-align: center; align-content: center;" >
...
.backDodecahedrom:hover{
    cursor: pointer;
}
.titleDodecahedromCard{
    position: absolute;
    top: 0%;
    left: 0%;
}
